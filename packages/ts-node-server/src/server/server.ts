...
import { attachScriptNodeToArg, getGit, getScript, getScriptComments, getScriptNode, getScripts, patchScriptComments, patchScriptNode, postScript, postScriptComments, removeScriptNodeToArg } from './endpoint/apiScript.js';
